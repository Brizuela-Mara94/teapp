...
<body class="bg-[#FDEFE7] font-sans min-h-screen flex flex-col">
    <header class="bg-white shadow-md w-full">
        <nav class="max-w-6xl mx-auto px-4 py-6">
            <div class="flex justify-between items-center">
                <img src="{{ asset('images/app-logo.png') }}" alt="TeApp Logo" class="w-12 h-12 object-contain lg:order-1">
                <div class="lg:hidden">
